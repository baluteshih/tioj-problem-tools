...
Description: Remove all the subtasks' data of a TIOJ problem. 

Return value: None
'''
def clean_subtasks_data(problem_id, tioj, settings):
    helper.throw_status(f"Cleaning the subtasks' data of TIOJ problem {problem_id}...")
